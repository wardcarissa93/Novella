        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    addressLineOne = table.Column<string>(type: "TEXT", unicode: false, maxLength: 50, nullable: false),
                    addressLineTwo = table.Column<string>(type: "TEXT", unicode: false, maxLength: 50, nullable: true),
                    city = table.Column<string>(type: "TEXT", unicode: false, maxLength: 20, nullable: false),
                    province = table.Column<string>(type: "TEXT", unicode: false, maxLength: 2, nullable: false),
                    postalCode = table.Column<string>(type: "TEXT", unicode: false, maxLength: 6, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    categoryName = table.Column<string>(type: "TEXT", unicode: false, maxLength: 20, nullable: false),
                    categoryDescription = table.Column<string>(type: "TEXT", unicode: false, maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    statusName = table.Column<string>(type: "TEXT", unicode: false, maxLength: 20, nullable: false),
                    statusDescription = table.Column<string>(type: "TEXT", unicode: false, maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    pkUserId = table.Column<string>(type: "TEXT", unicode: false, maxLength: 50, nullable: false),
                    firstName = table.Column<string>(type: "TEXT", unicode: false, maxLength: 20, nullable: false),
                    lastName = table.Column<string>(type: "TEXT", unicode: false, maxLength: 20, nullable: false),
                    role = table.Column<string>(type: "TEXT", unicode: false, maxLength: 10, nullable: false),
                    phoneNumber = table.Column<string>(type: "TEXT", unicode: false, maxLength: 10, nullable: false),
                    paypalAccount = table.Column<string>(type: "TEXT", unicode: false, maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    productName = table.Column<string>(type: "TEXT", unicode: false, maxLength: 50, nullable: false),
                    price = table.Column<decimal>(type: "decimal(6, 2)", nullable: false),
                    productDescription = table.Column<string>(type: "TEXT", unicode: false, maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    fkUserId = table.Column<string>(type: "TEXT", unicode: false, maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    fkUserId = table.Column<string>(type: "TEXT", unicode: false, maxLength: 50, nullable: false),
                    fkOrderStatusId = table.Column<int>(type: "INTEGER", nullable: false),
                    fkShippingAddressId = table.Column<int>(type: "INTEGER", nullable: false),
                    fkBillingAddressId = table.Column<int>(type: "INTEGER", nullable: false),
                    dateOrdered = table.Column<DateTime>(type: "datetime", nullable: false),
                    paypalTransactionId = table.Column<string>(type: "TEXT", unicode: false, maxLength: 12, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    fkUserId = table.Column<string>(type: "TEXT", unicode: false, maxLength: 50, nullable: false),
                    review = table.Column<string>(type: "TEXT", unicode: false, maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    pkProductCartId = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    pkProductOrderId = table.Column<int>(type: "INTEGER", nullable: false),
                    fkOrderId = table.Column<int>(type: "INTEGER", nullable: false),
                    fkProductId = table.Column<int>(type: "INTEGER", nullable: false),
                    quantityInOrder = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
